...
namespace SayanMac\Payment\Gateways;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\View;
use SayanMac\Payment\Exceptions\PaymentParametersMissingException;
...
class PayUMoneyGateway implements PaymentGatewayInterface
{
    ...
    public function checkParameters($parameters)
    {
        ...
        if ($validator->fails()) {
            throw new PaymentParametersMissingException($validator->errors());
        }
    }
